          ...
          <div className="mt-auto flex flex-wrap gap-2 text-[11px] sm:text-xs text-white/70">
            {visibleTags.map((tag, idx) => (
              <motion.span
                ...
                className="rounded-md bg-white/10 border border-white/10 px-2 py-1 font-medium text-white/75  drop-shadow-[0_8px_6px_rgba(0,0,0,0.5)]"
              >
                {tag}
              </motion.span>
            ))}
            ...
            {hiddenCount > 0 && visibleCount > 0 && (
              <motion.span
                ...
                variants={tagVariants}
                className="rounded-md bg-white/10 border border-dashed border-white/10 px-2 py-1 font-medium text-white/75  drop-shadow-[0_8px_6px_rgba(0,0,0,0.5)]"
              >
                +{hiddenCount}
              </motion.span>
            )}
