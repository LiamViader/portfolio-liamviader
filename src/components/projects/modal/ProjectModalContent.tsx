        ...
        <div className="px-6 pt-8 pb-8 sm:px-10 sm:pt-10 sm:pb-10 lg:px-12">
          ...
          >
            ...
            {project.detailed_media?.length ? (
              <>
                <div className="my-2 h-px w-full bg-gradient-to-r from-transparent via-sky-400/10 to-sky-400/30" />
                <ProjectMediaGallery
                  project={project}
            ...
            <div className="my-2 h-px w-full bg-gradient-to-r from-sky-400/30 via-sky-400/10 to-transparent" />
