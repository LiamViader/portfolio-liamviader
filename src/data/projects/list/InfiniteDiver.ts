...
export const InfiniteDiver: ProjectDefinition = {
  ...
  translations: {
    en: {
      ...
      short_description:
        "A 2D arcade mobile 'dropper' made in Unity where you fall through a night sky, avoiding obstacles.",
    ...
    es: {
      title: "Infinite Diver",
      short_description:
        "Un 'dropper' arcade 2D para móvil hecho en Unity donde caes por un cielo nocturno, evitando obstáculos.",
