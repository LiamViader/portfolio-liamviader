...
export const InfiniteDiver: ProjectDefinition = {
  ...
  translations: {
    en: {
      ...
      short_description:
        "A 2D arcade mobile 'dropper' made in Unity. Try to avoid obstacles while falling through a night sky.",
    ...
    es: {
      title: "Infinite Diver",
      short_description:
        "Un 'dropper' arcade 2D para móvil hecho en Unity. Intenta evitar obstaculos mientras caes por un cielo nocturno.",
