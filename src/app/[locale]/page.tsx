...
export default function Home() {
        ...
        return (
                <div className="flex flex-col gap-24 pb-24">
                        <section className="relative overflow-hidden rounded-3xl border border-white/10 bg-gray-950/70 px-4 py-24 shadow-[0_40px_100px_-40px_rgba(56,189,248,0.45)]">
                                <CanvasScene />
                        ...
                        <section className="relative px-4">
                                <div className="absolute inset-x-10 top-0 mx-auto h-px w-full max-w-5xl bg-gradient-to-r from-transparent via-white/20 to-transparent" />
                        ...
                        <section className="px-4">
                                <div className="relative mx-auto max-w-5xl overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-sky-500/20 via-purple-500/15 to-gray-900 p-10 text-center shadow-[0_20px_60px_-30px_rgba(56,189,248,0.6)] backdrop-blur">
                                        <div className="absolute -left-16 top-10 h-40 w-40 rounded-full bg-sky-500/20 blur-3xl" />
                                        <div className="absolute -right-16 bottom-10 h-40 w-40 rounded-full bg-purple-500/20 blur-3xl" />
